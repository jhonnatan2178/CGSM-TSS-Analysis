...
\begin{figure}[h!]
    ...
    \caption{Hydroclimatic analysis. (a)~Monthly Pajarales TSS
    (median $\pm$ 1~s.d.)  and the Oceanic Niño Index (ONI,
    NOAA~CPC), 2015--2025; red shading indicates El~Niño years,
    blue shading La~Niña, dashed lines the $\pm 0.5$°C threshold.
    (b)~Annual TSS anomaly (\% deviation from long-term median)
    and annual mean ONI; $r = 0.57$ ($p = 0.084$, borderline),
    consistent with El~Niño events corresponding to elevated TSS.
    (c)~Annual S1 water surface area vs.\ annual median TSS
    ($r = -0.766$, $p = 0.010$; detrended $r = -0.735$,
    $p = 0.016$, confirming the dilution signal is not an artefact
    of shared long-term drift).
    (d)~Diverging long-term trends: surface reflectance declining
    (B2: $\tau = -0.51$, B4: $\tau = -0.64$, both $p < 0.05$)
    while S1 water area increases ($\tau = +0.18$, $p = 0.002$),
    consistent with a declining Magdalena River sediment load.
    (e)~Monthly median TSS by ENSO phase (per-month ONI
    classification); Kruskal--Wallis $p = 0.53$ -- directionally
    suggestive (El~Niño~$>$~Neutral) but not statistically
    significant at $n = 27$ matched months.}
